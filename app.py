# app.py — ED Rota + AI Layer (Prefs, Forecast, Smart Swaps, NL Constraints)
# --------------------------------------------------------------------------
# Views: Day×Doctor, Doctor×Day, Day×Shift (cards)
# Solver: OR-Tools CP-SAT with slack, rest≥16h, ≤6 consecutive days, min off≥12, per-group caps
# AI Layer:
#   - Preference learning from CSV / hints -> reward terms in objective
#   - Demand forecasting -> adjusts coverage targets
#   - Smart swaps suggestions -> fill gaps and balance using local search
#   - Natural-language constraints parser for quick edits
# Excel export: Rota, Doctor×Day, Coverage gaps, Remaining, ByShift, Suggestions
